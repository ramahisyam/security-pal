...
public class DetailCheckupPermissionActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_checkup_permission);
    ...
    private void saveValue(String item) {
        if (item.equals("Change Status")) {
            ...
            checkUp.setCenter_approval(item);
