...
public class DetailVisitorPermissionActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_visitor_permission);
    ...
    private void saveValue(String item) {
        if (item.equals("Change Status")) {
            ...
            visitor.setCenter_approval(item);
